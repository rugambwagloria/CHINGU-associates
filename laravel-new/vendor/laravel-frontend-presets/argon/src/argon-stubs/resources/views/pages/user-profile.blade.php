...
@section('content')
            ...
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="/img/team-1.jpg" alt="school_image" class="w-100 border-radius-lg shadow-sm">
                    </div>
                </div>
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form role="form" method="POST" action={{ route('school.update') }} enctype="multipart/form-data">
                        @csrf
